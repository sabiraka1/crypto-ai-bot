...
class DummyBroker:
    ...
    async def fetch_order(self, symbol, broker_order_id):
        ...
        # simulate partial fill then closed
        return SimpleNamespace(status="closed", filled="1", amount="1", side="buy", price="100", fee_quote="0", ts_ms=2)
...
class OpenOrder: pass
    ...
    # After settlement there should be a trade and position base>0
