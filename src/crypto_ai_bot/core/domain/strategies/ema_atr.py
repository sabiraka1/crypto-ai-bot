...
class EmaAtrStrategy(BaseStrategy):
    ...
    - Ğ¡Ğ¸Ğ³Ğ½Ğ°Ğ» BUY, ĞºĞ¾Ğ³Ğ´Ğ° EMA_short > EMA_long Ğ¸ ĞºÑ€Ğ°Ñ‚ĞºĞ¾ÑÑ€Ğ¾Ñ‡Ğ½Ğ°Ñ EMA Ğ½Ğµ Â«Ğ¿Ğ»Ğ¾ÑĞºĞ°ÑÂ» (Ğ½Ğ°ĞºĞ»Ğ¾Ğ½ > ema_min_slope)
    ...
    Ğ Ğ°Ğ·Ğ¼ĞµÑ€Ñ‹ Ğ½Ğµ Ğ¾Ğ¿Ñ€ĞµĞ´ĞµĞ»ÑĞµÑ‚ â€” Ğ¾Ñ‚Ğ´Ğ°Ñ‘Ñ‚ Ñ‚Ğ¾Ğ»ÑŒĞºĞ¾ Ğ½Ğ°Ğ¿Ñ€Ğ°Ğ²Ğ»ĞµĞ½Ğ½Ñ‹Ğ¹ ÑĞ¸Ğ³Ğ½Ğ°Ğ» + reason.
    """
